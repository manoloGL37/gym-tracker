...
const local: Routine = { id: 'local-id', name: 'Local', exercises: [{ id: 'local-exercise', name: 'Press', setsCount: 3 }] };
const cloud: RoutineResponse = { id: 'cloud-id', clientId: 'stable-client-id', name: 'Cloud', description: null, exercises: [], createdAt: '2026-01-01T10:00:00', updatedAt: '2026-01-01T10:00:00' };
