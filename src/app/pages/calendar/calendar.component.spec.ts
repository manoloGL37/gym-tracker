...
describe('CalendarComponent unified history', () => {
  ...
  beforeEach(async () => {
    ...
    const migration = jasmine.createSpyObj<LocalToCloudMigrationService>('LocalToCloudMigrationService', ['isWorkoutMigrated']);
    migration.isWorkoutMigrated.and.callFake(async (_accountId: string, id: string) => id === 'already-synced');
    const workouts = jasmine.createSpyObj<WorkoutApiService>('WorkoutApiService', ['list']);
    workouts.list.and.returnValue(of({ content: [{ id: 'server-copy', routineId: 'server-routine', startedAt: '2026-09-01T10:00:00', completedAt: '2026-09-01T11:00:00', exercises: [] }], number: 0, totalPages: 1 } as any));
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: WorkoutApiService, useValue: workouts },
